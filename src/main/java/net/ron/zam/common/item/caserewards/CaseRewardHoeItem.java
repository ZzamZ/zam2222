...
public class CaseRewardHoeItem extends HoeItem {
    private final String collection;

    public CaseRewardHoeItem(String collection, ToolMaterial toolMaterial, float attackDamage, float attackSpeed, Properties properties) {
        super(toolMaterial, attackDamage, attackSpeed, properties);
        this.collection = collection;
    }

    public CaseRewardHoeItem(ToolMaterial toolMaterial, float attackDamage, float attackSpeed, Properties properties) {
