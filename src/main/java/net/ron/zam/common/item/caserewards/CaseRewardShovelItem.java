...
public class CaseRewardShovelItem extends ShovelItem {
    private final String collection;

    public CaseRewardShovelItem(String collection, ToolMaterial toolMaterial, float attackDamage, float attackSpeed, Properties properties) {
        super(toolMaterial, attackDamage, attackSpeed, properties);
        this.collection = collection;
    }

    public CaseRewardShovelItem(ToolMaterial toolMaterial, float attackDamage, float attackSpeed, Properties properties) {
