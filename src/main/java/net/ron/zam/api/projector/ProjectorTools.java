...
public final class ProjectorTools {
    ...
    public static Path ffprobe() throws Exception {
        ffmpeg();
        return FFPROBE;
    }
        ...
        try {
            ...
            try (ZipInputStream input = new ZipInputStream(Files.newInputStream(zip))) {
                ...
                while ((entry = input.getNextEntry()) != null) {
                    ...
                    if (name.equalsIgnoreCase("ffmpeg.exe"))
                        Files.copy(input, FFMPEG, StandardCopyOption.REPLACE_EXISTING);
                    else if (name.equalsIgnoreCase("ffprobe.exe"))
                        Files.copy(input, FFPROBE, StandardCopyOption.REPLACE_EXISTING);
                }
            }
